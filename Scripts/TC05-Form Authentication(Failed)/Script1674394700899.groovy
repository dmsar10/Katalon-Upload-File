...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_The Internet/input_Password_password'), 'nsbT9jSazufBmwEP3UKO4A==')

WebUI.click(findTestObject('Object Repository/Page_The Internet/i_Login'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_The Internet/div_Your password is invalid'), 0)
